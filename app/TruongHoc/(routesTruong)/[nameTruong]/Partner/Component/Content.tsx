...
import withHover from "./withHoverOpacity";
...
export const Content = () =>
{
    ...
    const HoverableImage = withHover(AwesomeImage) as React.ComponentType<HoverableImageProps>;
    ...
    <div className="flex flex-col">
      ...
      <div className="flex flex-col justify-center mx-auto mt-10">
        ...
        <div className="flex justify-center items-center h-52">
            <HoverableImage src="/Doitac/DoiTac_3.png" width={200} height={200} />
        </div>
