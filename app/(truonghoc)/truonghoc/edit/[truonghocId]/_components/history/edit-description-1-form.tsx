...
const EditDescription1Form = ({
  ...
  const form = useForm<z.infer<typeof formDes1Schema>>({
    resolver: zodResolver(formDes1Schema),
    defaultValues: {
      description1: description || "",
    },
  });

  const onSubmit = async (values: z.infer<typeof formDes1Schema>) => {
    try {
      await axios.patch(
...
export default EditDescription1Form;
