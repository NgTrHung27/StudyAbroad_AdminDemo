...
const page = () => {
  return (
    <div className="flex flex-col">
      ...
      <div className="container font-medium text-center mt-8 text-2xl">
      ...
      <div className="flex gap-10 mt-14 font-semibold container">
        <div>
          <Image
            width={800}
            height={400}
        ...
        <div className="w-full h-full mt-20 ml-10 text-2xl">
          <p className="p-3">
      ...
      <div className="flex flex-col justify-center container mt-10">
        <p className="text-center text-2xl font-bold p-10 ">
          Nhiều cơ hội kêt nối với các công ty cung cấp độc quyền chỉ <br></br>
          dành cho sinh viên được tuyển tại Vancourse{" "}
        </p>
        <p className="p-3 w-[1200px] text-left pl-48 font-semibold">
        ...
        <p className="p-3 w-[1200px] text-left pl-48 font-bold">
          Các buổi hội thảo: tổ chức các buổi hội thảo, bao gồm:
        </p>
        <p className="p-3 w-[1200px] text-left pl-48 font-semibold italic">
            &nbsp; &nbsp; - Buổi tập phỏng vấn mô phỏng: tổ chức các buổi tập phỏng vấn mô phỏng
          để giúp sinh viên luyện tập và cải thiện kỹ năng phỏng vấn.
        </p>
        <p className="p-3 w-[1200px] text-left pl-48 font-semibold italic">
            &nbsp; &nbsp;  - Buổi thuyết trình của diễn giả khách mời: mời các chuyên gia từ các
          ngành công nghiệp khác nhau (như nhà hàng, marketing, công nghệ...) Để
          chia sẻ hiểu biết và xu hướng trong ngành của họ (tuỳ chọn).
        </p>
        <p className="p-3 w-[1200px] text-left pl-48 font-semibold">
          Tư vấn hàng tháng: cung cấp các buổi tư vấn hàng tháng cá nhân hoặc nhóm để giải quyết những nhu cầu cụ thể liên quan đến sự nghiệp của sinh viên và cung cấp hướng dẫn cá nhân hóa.
        </p>
      </div>
