...
const Contact = () => {
  return (
    <div className="w-full min-h-screen ">
      <div className="bg-white w-full h-[770px]">
        <div className="h-full w-full grid grid-cols-1 md:grid-cols-2 ">
          <div className="">
            <div className="flex items-center justify-between gap-x-3 px-12 mt-12">
              <h1 className="text-3xl capitalize font-bold">Liên hệ</h1>
            </div>
            <div className="mx-12 pt-2 max-w[60%] mt-12">
              <ul className="list-none decoration-slice text-lg font-medium space-y-8 text-[#777E90] ">
                <li className="flex justify-between">
                  <span>
                    {" "}
                    <strong>Văn phòng miền Nam:</strong> Tầng 75 Landmark 81,
                    720A Đ. Điện Biên Phủ, Vinhomes Tân Cảng, Bình Thạnh, Thành
                ...
                <li className="flex justify-between mt-10">
                  <span>
                    {" "}
                    <strong>Văn phòng miền Bắc:</strong> 5 P. Hoàng Văn Thụ,
                    Quán Thánh, Ba Đình, Hà Nội, Việt Nam
                  </span>
                </li>
                <li className="flex justify-between mt-4">
                  <span>
          ...
          <div className="">
            ...
            <div className="mx-12 pb-10 mt-6 ">
              ...
              <span className="flex flex-col text-[12px] md:text-15px">
                *Sau khi nhận được thông tin, chúng tôi sẽ tư vấn cho bạn hoàn
                toàn miễn phí
              </span>
            </div>
          </div>
