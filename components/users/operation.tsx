  ...
  return (
    <div>
            ...
            <div className='bg-white w-[92%] min-h-[144px] z-20 absolute top-[70px] mb-5 flex flex-col'>
              <div className='flex flex-row justify-center '>
                ...
                <div className='flex flex-col items-center text-center text-black font-[28px]'>
                  <p style={{ letterSpacing: "-0.5px" }}>Cornerstone International Community College là trường  </p>
                  <p style={{ letterSpacing: "-0.5px", marginTop: "-5px" }}>cao đẳng tư thục lớn nhất ở Vancouver.</p>
                </div>
                <div><Image className='mx-1' alt='/' src={"/Truong1/book.png"} width={24} height={24} /></div>
              </div>
              <div className='flex flex-row justify-center items-center'>
                <div className='flex flex-col mt-2 justify-center items-center'>
                  ...
                  <div className='flex flex-col mt-2'>
                    <p style={{ letterSpacing: "-0.5px" }}>Trường có 3 cơ sở :</p>
                    <p style={{ letterSpacing: "-0.5px" }} className='mt-[-5px]'> West Hastings, Granville và Seymore.</p>
                  </div>
                </div>
                ...
                <div className='flex flex-col mt-2 justify-center items-center'>
                  <div><Image className='mx-1' alt='/' src={"/Truong1/brifecase.png"} width={34} height={36} /></div>
                  <div className='flex flex-col mt-2'>
                    <p style={{ letterSpacing: "-0.5px" }}> Thêm 1 cơ sở đang được xây dựng tại Gastown</p>
                    <p style={{ letterSpacing: "-0.5px" }} className='mt-[-5px]'>  cho các chương trình công nghệ.</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className='w-full min-h-screen '>
        ...
        <Image alt='/' src='/Truong1/bg-operations.png' width={1440} height={0} className='w-full h-full z-0 ' />
            <div className='z-10 grid grid-cols-3 gap-4 absolute top-[280px] left-1 w-full h-auto px-5 '>
